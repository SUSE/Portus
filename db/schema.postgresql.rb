...
ActiveRecord::Schema.define(version: 2019_03_14_173309) do
  ...
  create_table "application_tokens", id: :serial, force: :cascade do |t|
  ...
  create_table "registry_events", id: :serial, force: :cascade do |t|
  ...
  create_table "scan_results", id: :serial, force: :cascade do |t|
    t.integer "tag_id"
  ...
  create_table "vulnerabilities", id: :serial, force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "webhook_headers", id: :serial, force: :cascade do |t|
    t.integer "webhook_id"
    t.string "name"
    t.string "value"
    t.datetime "created_at", null: false
